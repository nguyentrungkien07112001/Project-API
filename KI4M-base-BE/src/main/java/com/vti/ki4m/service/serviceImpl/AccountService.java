...
public class AccountService implements IAccountService {
    ...
    @Override
    public String activeAccount(HttpServletResponse response, String token) throws IOException, InterruptedException {
...
//            response.sendRedirect("http://localhost:8090/api/v1/accounts");
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (account == null) {
            throw new UsernameNotFoundException("User " + username + " không có trong Database");
        }
